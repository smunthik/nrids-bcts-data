...
(
    ...
    AND tt.legal_effective_dt BETWEEN DATE '2015-04-01'
                                AND DATE '2025-03-31'
),
...
(
    ...
    WHERE UPPER(tb.sale_awarded_ind) = 'Y'  -- Only winning bid
    AND ts1.auction_date BETWEEN DATE '2015-04-01'
                            AND DATE '2025-03-31'
), 
per_licence as 
    (
    SELECT DISTINCT
        ...
        CASE
            WHEN ts.no_sale_rationale_code IS NULL
                ...
                AND tt.legal_effective_dt BETWEEN DATE '2015-04-01' AND DATE '2025-03-31'  -- reporting period
            THEN 'Y'
            ELSE 'N'
        END AS Sold_in_Report_Period,

        CASE
            WHEN ts.auction_date BETWEEN DATE '2015-04-01' AND DATE '2025-03-31'
            THEN 'Y'
            ELSE 'N'
    ...
    WHERE
        (
            ...
            AND tt.legal_effective_dt BETWEEN DATE '2015-04-01' AND DATE '2025-03-31')
            -- Criteria for auctions within the reporting period
            OR ts.auction_date BETWEEN DATE '2015-04-01' AND DATE '2025-03-31'
        )
