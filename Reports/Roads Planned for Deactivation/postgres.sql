...
SELECT
    ...
    CASE
        ...
        < EXTRACT(YEAR FROM (DATE '2026-02-28' + INTERVAL '9 months'))
        THEN
            'Past Fiscals (Pre-'
            || EXTRACT(YEAR FROM (DATE '2026-02-28' + INTERVAL '9 months'))
            || ')'
        ...
        WHEN EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
        - EXTRACT(YEAR FROM (DATE '2026-02-28' + INTERVAL '9 months')) = 1
        THEN
            '1st Fiscal ('
            || EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
            || ')'
        ...
        WHEN EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
        - EXTRACT(YEAR FROM (DATE '2026-02-28' + INTERVAL '9 months')) = 2
        THEN
            '2nd Fiscal ('
            || EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
            || ')'
        ...
        WHEN EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
        - EXTRACT(YEAR FROM (DATE '2026-02-28' + INTERVAL '9 months')) = 3
        THEN
            '3rd Fiscal ('
            || EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
            || ')'
        ...
        WHEN EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
        - EXTRACT(YEAR FROM (DATE '2026-02-28' + INTERVAL '9 months')) = 4
        THEN
            '4th Fiscal ('
            || EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
            || ')'
        ...
        WHEN EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
        - EXTRACT(YEAR FROM (DATE '2026-02-28' + INTERVAL '9 months')) = 5
        THEN
            '5th Fiscal ('
            || EXTRACT(YEAR FROM (deac_planned_date + INTERVAL '9 months'))
            || ')'
        ...
        THEN
            '6th Fiscal-Onwards ('
            || (EXTRACT(YEAR FROM (DATE '2026-02-28' + INTERVAL '9 months')) + 6)
            || '+)'
    END AS fiscal
