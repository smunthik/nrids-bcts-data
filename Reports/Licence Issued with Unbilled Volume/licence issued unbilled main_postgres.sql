CREATE OR REPLACE VIEW bcts_staging.licence_issued_unbilled_main AS
SELECT
...
FROM
    bcts_staging.qLicenceIssuedUnbilled_Official AS official
    LEFT JOIN bcts_staging.qLicenceIssuedUnbilled_LRM AS lrm ON official.forest_file_id = lrm.licence_id
WHERE
