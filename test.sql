        ...
        (
            ...
            WHERE
                ...
                AND FF1.FOREST_FILE_ID IN (
                    ...
                    WHERE
                        FF0.LICENSEE_START_DATE BETWEEN To_Date ('2025-04-01', 'YYYY-MM-DD') -- Report period start date
    AND To_Date  ('2025-12-01', 'YYYY-MM-DD') -- Report period end date
                )
            GROUP BY
                FF1.FOREST_FILE_ID
            HAVING
    ...
    SELECT DISTINCT
        ...
        '2025-04-01'::Date as report_start_date,
        '2025-12-01'::Date as report_end_date
